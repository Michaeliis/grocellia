<head><title>New Staff</title></head>
<!-- MAIN CONTENT-->
                ...
                <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="<?php echo base_url(). 'staff/insert_staff'; ?>" method="post" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="position" placeholder="Position" class="form-control">
                                                </div>
                                            </div>
                                    </div>
